...
-(void)setUpChartwithAnimation:(BOOL)withAnimation {
	...
	}else if (self.chartStyle == UUChartBarStyle)
	{
        ...
        [_barChart strokeChartwithAnimation:withAnimation];
	}
}

- (void)showInView:(UIView *)view withAnimation:(BOOL)withAnimation
{
    [self setUpChartwithAnimation:withAnimation];
    [view addSubview:self];
}

-(void)strokeChartwithAnimation:(BOOL)withAnimation
{
	[self setUpChartwithAnimation:withAnimation];
